...
execute 'test' do
	...
	command 'git clone https://'+node[:awscli][:GIT_USER]+':'+node[:awscli][:GIT_PASS]+'@git-codecommit.us-east-1.amazonaws.com/v1/repos/myapp-codecommit  /var/myapp-codecommit'
	#command 'cd root/myapp-codecommit'
	cwd "/var/myapp-codecommit"
